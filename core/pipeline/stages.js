...
const STAGES = {
  ...
  "pre-review": {
    ...
    allowedWrites: ["pipeline/pre-review.md", "pipeline/lint-output.txt", "pipeline/pre-review-output.txt", "pipeline/gates/stage-04a.json", "pipeline/context.md"],
  ...
  "accessibility-audit": {
    ...
    allowedWrites: ["pipeline/accessibility-report.md", "pipeline/axe-report.json", "pipeline/gates/stage-06b.json", "pipeline/context.md"],
  ...
  "verification-beyond-tests": {
    ...
    allowedWrites: ["pipeline/verification-report.md", "pipeline/gates/stage-06d.json", "pipeline/context.md", "src/tests/property/", "pipeline/formal/", "reports/"],
  ...
  "performance-budget": {
    ...
    readFirst: ["AGENTS.md", ".devteam/rules/pipeline.md", ".devteam/rules/gates-core.md", "pipeline/context.md", "pipeline/brief.md", "pipeline/design-spec.md", "pipeline/test-report.md"],
    allowedWrites: ["pipeline/performance-report.md", "pipeline/lhci-result.json", "pipeline/gates/stage-06e.json", "pipeline/context.md"],
