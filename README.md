...
|---|---|
| `devteam init --host <name>[,<name>...]` | Install host adapter(s) into the current project; write `.devteam/config.yml`; write (or update) the managed `.gitignore` block of volatile Stagecraft files |
