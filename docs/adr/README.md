...
| [010](010-git-integration.md) | Git integration: managed gitignore block via `devteam init`, `devteam commit` as primary git interface, `--auto-commit` on clean halts, `last_committed_stage_index` cursor | Proposed |
