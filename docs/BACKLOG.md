...
| A8 | **Omnigent runtime adapter follow-through** ([#291](https://github.com/telus-labs/stagecraft/issues/291)) | 4 | 4 | Phase 24.1 ships a conservative `omnigent` host adapter. Follow-through tracks launch config ([#292](https://github.com/telus-labs/stagecraft/issues/292)), prompt-file transport ([#293](https://github.com/telus-labs/stagecraft/issues/293)), policy bridging ([#294](https://github.com/telus-labs/stagecraft/issues/294)), session evidence ([#295](https://github.com/telus-labs/stagecraft/issues/295)), and optional director-mode consolidation ([#296](https://github.com/telus-labs/stagecraft/issues/296)). See [Phase 24](../plans/phase-24-omnigent-runtime.md). |
