...
3. **C5 — Capability-required permissions** (3 / 2). Multi-host routing has been shipped; this is the piece that makes it safe by construction. Old BACKLOG item, *more* relevant now than when first written. **Start here.**
