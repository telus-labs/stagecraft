...
4. **E7 — `/goal` integration** (3 / 2). Convergence-shaped stages (build, QA) are exactly where host-driven loops beat framework-driven retries. BMAD's conversational refinement gives empirical cover. **Start here.**
