...
|---|---|---|---|
| **Stage** | `core/pipeline/stages.js` | The framework | A numbered phase of work (e.g. `stage-01` requirements, `stage-04` build, `stage-09` retrospective). 16 stages total (including sub-stages 3b, 4a/4b/4c/4d, 6b, 6c). |
...
6. The **track** you picked (`full`) is what put all 16 stages on the menu. Picking `nano` would skip everything except build + qa.
