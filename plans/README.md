...
| 14 | [phase-14-dogfooding-support.md](phase-14-dogfooding-support.md) | [prompts](prompts/ALL-PROMPTS.md) | Dogfooding support: `devteam init --profile dogfood`, doctor checks, preflight staged-artifact guard, budget warning, guide | ✅ 14.1 complete (PR #163) · ✅ 14.2 complete (PR #164) · ✅ 14.3 complete (PR #165) · 🔲 14.4 ready · 14.5 blocked on 14.2 |
