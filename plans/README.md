...
| 12 | [phase-12-git-workflow-automation.md](phase-12-git-workflow-automation.md) | [prompts](prompts/ALL-PROMPTS.md) | Git workflow automation (ADR-010): managed gitignore, `devteam commit`, `--auto-commit`, git-workflow.md restructure | 🔲 in progress — 12.1 ✅ managed gitignore (`devteam init`); 12.2 unblocked |
